...
sqlalchemy.url = mysql+aiomysql://root:@localhost:3306/dict_procurement?charset=utf8mb4
...
'''
    ...
    script_mako_content = '''"""Mako template for Alembic migration scripts"""
...
'''
    ...
    print("\n🎯 Next steps:")
    print("   1. Review alembic.ini for database connection")
